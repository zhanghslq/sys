...
<div class="content">
    ...
    <div class="contentRight">
      <iframe id="Iframe" src="../main/base.jsp" class="introduceNav"   scrolling="auto" frameborder="0"  marginwidth="0" marginheight="0" ></iframe>
    </div>
    <!--右边 结束-->
</div>
</body>
...
<script>
	...
	$(window).load(function(){
		var cH = $(".introduceNav").contents().find("#contentRightHeight").height();
		$(".introduceNav").height(cH).attr("height",cH);
	}); 
	$(".introduceNav").attr("src","../main/base.jsp?random="+ Math.floor(Math.random()*100000))
	}) 
</script>
</html>
