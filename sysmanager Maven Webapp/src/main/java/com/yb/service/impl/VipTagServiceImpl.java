...
public class VipTagServiceImpl implements VipTagService{
	...
	public List<VipTag> query(List<String> loyalty, List<String> identity,
			...
			List<String> mopType, Integer index, Integer number,List<String> ids) {
		// TODO Auto-generated method stub
		List<VipTag> query = vipTagDao.query(loyalty, identity, gender, age, type, coupon, recentOil, recentNotOil, shortOil, station, oilName, shopName, mopType, index, number,ids);
		return query;
	}
	@Override
	public Integer queryTotal(List<String> loyalty, List<String> identity,
			...
			List<String> recentNotOil, List<String> shortOil,
			List<String> station, List<String> oilName, List<String> shopName,
			List<String> mopType,List<String> ids) {
		// TODO Auto-generated method stub
		Integer queryTotal = vipTagDao.queryTotal(loyalty, identity, gender, age, type, coupon, recentOil, recentNotOil, shortOil, station, oilName, shopName, mopType,ids);
		return queryTotal;
	}
