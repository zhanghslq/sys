 ...
 * @author user
 */
public final class EchartsExportExcelUtil {

  /***
   * 构造方法
   */
  private EchartsExportExcelUtil() {
 ...
 /***
   ...
   *        sheet名称和表头值
   */
  public static HSSFWorkbook excelExport(List<?> dataList, Map<String, String> titleMap, String sheetName,Date start,Date end) {
    // 初始化workbook
