...
public class OilController {
	...
	public void exportOils(HttpServletResponse response,@RequestParam(required=false,value="citys")String[] citys,
		...
		String encode="";
		try {
			encode = URLEncoder.encode("燃油销售整体情况.xlsx", "UTF-8");
		...
		titleMap.put("oilNumber", "销售笔数");
		titleMap.put("oilLitre", "销售升数");
		titleMap.put("oilMoney", "平均单笔销售升数");
	...
	public void exportByOils(HttpServletResponse response,@RequestParam(required=false,value="citys")String[] citys,
		...
		String encode="";
		try {
			encode = URLEncoder.encode("燃油分油品销售情况.xlsx", "UTF-8");
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
